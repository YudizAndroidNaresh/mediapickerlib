...
package com.mediapickerlib.camera2.customview;
 ...
 */
public class AutoFitTextureViewFill extends TextureView {
    ...
    public AutoFitTextureViewFill(Context context) {
        this(context, null);
    }

    public AutoFitTextureViewFill(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AutoFitTextureViewFill(Context context, AttributeSet attrs, int defStyle) {
