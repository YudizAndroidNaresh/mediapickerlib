...
package com.mediapickerlib.cropper;
...
public final class CropImage {
  ...
  public static final class ActivityBuilder implements Parcelable {
    ...
    protected ActivityBuilder(Parcel in) {
      mSource = in.readParcelable(Uri.class.getClassLoader());
      mOptions = in.readParcelable(CropImageOptions.class.getClassLoader());
    }

    public static final Creator<ActivityBuilder> CREATOR = new Creator<ActivityBuilder>() {
      @Override
      public ActivityBuilder createFromParcel(Parcel in) {
        return new ActivityBuilder(in);
      }

      @Override
      public ActivityBuilder[] newArray(int size) {
        return new ActivityBuilder[size];
      }
    };
     ...
     */
    public void start(@NonNull Activity activity, @Nullable Uri source) {
      mOptions.validate();
      mSource = source;
     ...
     * @param activity activity to receive result
     */
    public void start(@NonNull Activity activity, @Nullable Class<?> cls, @Nullable Uri source) {
      mOptions.validate();
      mSource = source;
     ...
     */
    public void start(@NonNull Context context, @NonNull Fragment fragment, @Nullable Uri source) {
      mSource = source;
    ...
    public void start(@NonNull Context context, @NonNull android.app.Fragment fragment, @Nullable Uri source) {
      mSource = source;
      fragment.startActivityForResult(getIntent(context), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
    }
     ...
     */
    public void start(
            @NonNull Context context, @NonNull Fragment fragment, @Nullable Class<?> cls, @Nullable Uri source) {
      mSource = source;
    ...
    @RequiresApi(api = Build.VERSION_CODES.HONEYCOMB)
    public void start(
            @NonNull Context context, @NonNull android.app.Fragment fragment, @Nullable Class<?> cls, @Nullable Uri source) {
      mSource = source;
      fragment.startActivityForResult(getIntent(context, cls), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
      parcel.writeParcelable(mSource, flags);
      parcel.writeParcelable(mOptions, flags);
    }
  }
  // endregion
